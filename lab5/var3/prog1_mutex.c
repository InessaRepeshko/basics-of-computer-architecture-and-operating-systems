 ...
 * два потоки записують і читають інформаціює з одного файлу.
 * Необхідно забезпечити синхнонізовано роботу потоків у критичній секції з використанням мʼютексів. */
